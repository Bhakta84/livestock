...
### 📈 Data Visualization
- **Daily Pig Count Chart**: Line chart showing pig trends over 7 days
- **Daily Egg Collection Chart**: Bar chart showing egg collection over 7 days
- **Weekly Comparison Chart**: Combined view of both pigs and eggs for comparison
...
### Adding Pig Entries
1. Navigate to the "Add Pig Entry" form on the left side
